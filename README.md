...
Rgy (pronouned reggie) is a small library that helps make your regular expressions more human-readable, is self documenting, and even better, you don't need to know any regex at all to use it.
